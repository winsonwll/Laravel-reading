...
Component.options.__file = "resources\\assets\\js\\components\\page\\BookEdit.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f4049562", Component.options)
  } else {
    hotAPI.reload("data-v-f4049562", Component.options)
' + '  }
...
var quill = __webpack_require__(201)
var quillEditor = __webpack_require__(207)
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ac055a92", Component.options)
  } else {
    hotAPI.reload("data-v-ac055a92", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(198)("36a223e4", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-ac055a92\",\"scoped\":false,\"hasInlineConfig\":true}!../../vue-loader/lib/selector.js?type=styles&index=0&bustCache!./editor.vue", function() {
     var newContent = require("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-ac055a92\",\"scoped\":false,\"hasInlineConfig\":true}!../../vue-loader/lib/selector.js?type=styles&index=0&bustCache!./editor.vue");
...
if (!window.Quill) {
  window.Quill = __webpack_require__(201);
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-ac055a92", module.exports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_quill_editor__ = __webpack_require__(202);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    data: function data() {
        return {
            ...
            rules: {
                title: [{ required: true, message: '请输入书名', trigger: 'blur' }, { min: 1, max: 20, message: '长度在 1 到 20 个字符', trigger: 'blur' }],
                catalog: [{ required: true, message: '请输入一句话序言', trigger: 'blur' }],
                gid: [{ required: true, message: '请选择类别', trigger: 'change' }],
    ...
    methods: {
        getData: function getData() {
            ...
            var self = this;
            var url = __WEBPACK_IMPORTED_MODULE_0__config__["a" /* apiDomain */] + 'book/' + this.$route.params.id + '/edit';
            ...
            this.$refs[formName].validate(function (valid) {
                if (valid) {
                    ...
                    _this2.$http.post(url, {
                        ...
                        catalog: _this2.form.catalog,
                        gid: _this2.form.gid,
                        detail: _this2.form.detail,
                        status: _this2.form.status ? 1 : 0
                    }).then(function (res) {
                        if (res && res.status == 200 && res.data.status) {
                            _this2.$message.success('图书创建成功！');
                            setTimeout(function () {
                                _this2.$router.push('/bookindex');
                            }, 1e3);
                        } else {
                            _this2.$message.error('图书创建失败！');
                        }
      ...
      [
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("el-breadcrumb-item", [_vm._v("编辑图书")])
          ],
          1
        )
      ],
      ...
      [
        _c(
          ...
          [
            _c(
              "el-form-item",
              { attrs: { label: "书 名", prop: "title" } },
              [
                _c("el-input", {
                  attrs: { placeholder: "请输入书名" },
                  model: {
                    value: _vm.bookData.title,
                    callback: function($$v) {
                      _vm.$set(
                        _vm.bookData,
                        "title",
            ...
            _c(
              "el-form-item",
              { attrs: { label: "序 言", prop: "catalog" } },
              [
                _c("el-input", {
                  attrs: { placeholder: "一句话序言" },
                  model: {
                    value: _vm.bookData.catalog,
                    callback: function($$v) {
                      _vm.$set(
                        _vm.bookData,
                        "catalog",
              ...
              [
                _c(
                  "el-select",
                  {
                    ...
                    model: {
                      value: _vm.bookData.genre,
                      callback: function($$v) {
                        _vm.$set(_vm.bookData, "genre", $$v)
                      },
                      expression: "bookData.genre"
                    }
                  },
            ...
            _c(
              "el-form-item",
              { attrs: { label: "图书详情", prop: "detail" } },
              [
                _c("quill-editor", {
                  ref: "myTextEditor",
                  attrs: { options: _vm.form.editorOption },
                  on: {
                  ...
                  model: {
                    value: _vm.bookData.detail,
                    callback: function($$v) {
                      _vm.$set(_vm.bookData, "detail", $$v)
                    },
                    expression: "bookData.detail"
                  }
                })
              ],
              1
            ...
            _c(
              "el-form-item",
              { attrs: { label: "是否上线", prop: "status", required: "" } },
              [
                _c("el-switch", {
                  model: {
                    value: _vm.bookData.status,
                    callback: function($$v) {
                      _vm.$set(_vm.bookData, "status", $$v)
                    },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-f4049562", module.exports)
  }
}
