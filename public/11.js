...
Component.options.__file = "resources\\assets\\js\\components\\page\\BookCreate.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1a596801", Component.options)
  } else {
    hotAPI.reload("data-v-1a596801", Component.options)
' + '  }
            ...
            this.$refs[formName].validate(function (valid) {
                if (valid) {
                    ...
                    _this.$http.post(url, {
                        ...
                        catalog: _this.form.catalog,
                        gid: _this.form.gid,
                        detail: _this.form.detail,
                        status: _this.form.status ? 1 : 0
                    }).then(function (res) {
                        if (res && res.status == 200 && res.data.status) {
                            _this.$message.success('图书创建成功！');
                            setTimeout(function () {
                                _this.$router.push('/bookindex');
                            }, 1e3);
                        } else {
                            _this.$message.error('图书创建失败！');
                        }
                        _this.loading = false;
      ...
      [
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("el-breadcrumb-item", [_vm._v("添加图书")])
          ],
          1
        )
      ],
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1a596801", module.exports)
  }
}
